...
const Page=()=>{
	...
	const part=parts.find((e)=>Number(e.id)===Number(id))
	useEffect(()=>{
		getParts
	},[])
	return (
	<div className='container mx-auto p-4 md:p-8 bg-white'>
			<div className='grid grid-cols-1 lg:grid-cols-[minmax(0,500px)_1fr] gap-8'>
				...
				<div className='flex flex-col'>
					...
					<Button className='mt-8 w-full py-[25px] bg-[#1e2133] hover:bg-[#687288] text-white text-lg font-semibold rounded-lg shadow-md'>
